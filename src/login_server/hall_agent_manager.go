...
import (
	...
	"ih_server_new/libs/server_conn"
...
func H2LAccountBanHandler(conn *server_conn.ServerConn, m proto.Message) {
	...
	if ban > 0 {
		...
		ban_player.Set_player_id(pid)
		now_time := time.Now()
		ban_player.Set_start_time(int32(now_time.Unix()))
		ban_player.Set_start_time_str(now_time.Format("2006-01-02 15:04:05"))
	} else {
		ban_player.Set_start_time(0)
		ban_player.Set_start_time_str("")
	}
